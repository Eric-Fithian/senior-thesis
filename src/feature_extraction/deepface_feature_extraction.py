...
if __name__ == "__main__":
    ...
    extract_bulk(
        ...
        output_dir='../../data/processed/deepface/facenet',
        model_name=model_name,
        detector_backend=detector_backend,
        frame_skip=frame_skip
    )
    
# extract_deepface_embeddings('../../data/interim/video/P011_P.mp4', '../../data/processed/deepface/facenet', model_name='Facenet', detector_backend='opencv', frame_skip=3, show_progress=True)